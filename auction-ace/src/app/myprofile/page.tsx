...
export default function page() {
  ...
  return (
    <div>
      <Section section_name1={"Profile"} section_name2={"MyProfile"} />
      <DashboardSections section_active="myprofile" />

      <div>
        <div className="flex items-center justify-center p-4  py-3">
          <div className="w-full md:w-1/2 h-full signUpBox flex items-center justify-start border-2 border-[#805D5D] bg-white rounded-lg flex-col">
            ...
            <form>
                <div className="flex items-center w-full justify-center">
                    <div className="text-lg text-slate-50 bg-[#E3AF46] px-7 py-2 mt-4 rounded-lg w-50 text-center cursor-pointer" onClick={enable_inputs}>
                        Edit
                    </div>
                </div>


              <fieldset id="form" disabled className="flex items-center justify-around flex-col w-full p-4 disabled:opacity-70">
