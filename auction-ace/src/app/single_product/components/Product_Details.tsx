...
export default function Product_Details() {
  return (
    <div className="flex items-center justify-around p-2 flex-wrap w-full">


        <div className="flex items-center justify-between p-2 w-full lg:w-1/2">
          <div className='flex items-center justify-around p-2 flex-col w-1/3 sm:w-1/5'>
            <Image src={prod_img1} alt="Product" className='my-2 w-full'></Image>
            <Image src={prod_img1} alt="Product" className='my-2 w-full'></Image>
            <Image src={prod_img1} alt="Product" className='my-2 w-full'></Image>
          </div>
            <Image src={prod_img1} alt="Product" className='my-2 w-2/3 sm:w-4/5'></Image>
        </div>

        {/* product description container */}
        <div className='flex items-center justify-center flex-col w-full sm:w-4/5 md:w-2/3 lg:w-2/5 md:px-2'>
          ...
          <div className='flex items-start justify-start p-2 flex-col my-3 shadow-lg w-full border-[1.5px] border-gray-300 rounded-lg sm:w-3/4 md:w-full sm:p-4 bg-white'>
            ...
            <form className='flex items-center justify-around w-full p-1'>
              <input className="bg-gray-300 text-gay-600 px-2 py-1 text-lg rounded-lg" placeholder='$00.00'></input>
              <button className='bg-[#e3af46] px-2 py-1 text-center text-lg rounded-lg'> Place Bid</button>
            </form>
          </div>
        </div>
        ...
        <div className='flex items-center justify-around w-full'>
            <button className='bg-[#e3af46] px-2 py-1 text-center text-lg rounded-lg'>Description</button>
            <button className='bg-slate-50 border-[1.5px] border-gray-500 px-2 py-1 text-center text-lg rounded-lg'>Bidding History</button>
        </div>

        {/* Description subsection */}
        <div className='flex items-center justify-center w-full sm:w-4/5 md:w-full lg:w-4/5 flex-col p-2 my-2'>
        <p className='w-full text-xl text-gray-900 font-semibold'>USPA white shoes with black accent</p>
