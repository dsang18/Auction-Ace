...
export default function Reviews() {
  return (
    <div className="flex items-center justify-around flex-wrap p-4 sm:flex-col lg:flex-row md:w-full">

      <div className="flex items-center justify-around flex-row border border-gray-300 p-4 shadow-md w-full sm:w-1/2 lg:w-1/4 my-4 rounded-md">
